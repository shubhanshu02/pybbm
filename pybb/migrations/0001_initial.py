    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to=pybb.util.FilePathGenerator(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "position",
                    models.IntegerField(default=0, verbose_name="Position", blank=True),
                ),
                (
                    "hidden",
                    models.BooleanField(
                        default=False,
                        help_text="If checked, this category will be visible only for staff",
                        verbose_name="Hidden",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "updated",
                    models.DateTimeField(null=True, verbose_name="Updated", blank=True),
                ),
                (
                    "post_count",
                    models.IntegerField(
                        default=0, verbose_name="Post count", blank=True
                    ),
                ),
                (
                    "topic_count",
                    models.IntegerField(
                        default=0, verbose_name="Topic count", blank=True
                    ),
                ),
                ("hidden", models.BooleanField(default=False, verbose_name="Hidden")),
                (
                    "headline",
                    models.TextField(null=True, verbose_name="Headline", blank=True),
                ),
                (
                    "category",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "forum",
                    models.ForeignKey(
                        blank=True, on_delete=models.CASCADE, to="pybb.Forum", null=True
                    ),
                ),
                (
                    "user",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        db_index=True, verbose_name="Created", blank=True
                    ),
                ),
                (
                    "updated",
                ...
                (
                    ...
                    models.IPAddressField(
                        default="0.0.0.0", verbose_name="User IP", blank=True
                    ),
                ),
                (
                    "on_moderation",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "signature",
                    models.TextField(
                        max_length=1024, verbose_name="Signature", blank=True
                    ),
                ),
                (
                    "signature_html",
                ...
                (
                    "show_signatures",
                    models.BooleanField(default=True, verbose_name="Show signatures"),
                ),
                (
                    "post_count",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "views",
                    models.IntegerField(
                        default=0, verbose_name="Views count", blank=True
                    ),
                ),
                ...
                (
                    "poll_question",
                    models.TextField(
                        null=True, verbose_name="Poll question", blank=True
                    ),
                ),
                (
                    "forum",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "topic",
                    models.ForeignKey(
                        blank=True, on_delete=models.CASCADE, to="pybb.Topic", null=True
                    ),
                ),
                (
                    "user",
