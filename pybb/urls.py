...
urlpatterns += [
    ...
    url(r"^topic/(?P<topic_id>\d+)/post/add/$", AddPostView.as_view(), name="add_post"),
    # Post
    url(r"^post/(?P<pk>\d+)/$", PostView.as_view(), name="post"),
    url(r"^post/(?P<pk>\d+)/edit/$", EditPostView.as_view(), name="edit_post"),
    url(r"^post/(?P<pk>\d+)/move/$", MovePostView.as_view(), name="move_post"),
    url(r"^post/(?P<pk>\d+)/delete/$", DeletePostView.as_view(), name="delete_post"),
    url(r"^post/(?P<pk>\d+)/moderate/$", ModeratePost.as_view(), name="moderate_post"),
    # Attachment
    ...
    url(r"^subscription/topic/(\d+)/add/$", add_subscription, name="add_subscription"),
    url(
