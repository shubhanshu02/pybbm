...
urlpatterns += [
    ...
    url(
        "^topic/(?P<pk>\d+)/unstick/$", UnstickTopicView.as_view(), name="unstick_topic"
    ),
    ...
    url(
        "^topic/(?P<pk>\d+)/poll_vote/$",
        TopicPollVoteView.as_view(),
        name="topic_poll_vote",
    ),
    url(
        "^topic/(?P<pk>\d+)/cancel_poll_vote/$",
        topic_cancel_poll_vote,
    ...
    # Add topic/post
    url(
        "^forum/(?P<forum_id>\d+)/topic/add/$", AddPostView.as_view(), name="add_topic"
    ),
